...
--播放背景音乐
function PLAY_BACKGROUND_MUSIC(str)
	print("播放音乐")
	if str then
		audio.playMusic("majia/sound/" .. str .. ".mp3",true)
	else
		audio.playMusic("majia/sound/main_bg.mp3",true)
	end
...
function PLAY_SOUND_CLICK()
	PLAY_SOUND("majia/sound/click.mp3")
end
